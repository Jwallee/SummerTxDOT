...
def import_from_file():
    global selected_field, training_size, testing_size, data_file1, data_folder2, cv_value
...
if selected_field and data_file1 and data_folder2 and training_size and testing_size and cv_value:
    enable_fields(False)
